...
namespace AIO.Content.Tiles
{
	...
	public class HellPylonTile : ModPylon
	{
		...
		public override void SetStaticDefaults() {
			...
			TEModdedPylon moddedPylon = ModContent.GetInstance<TileEntities.SimplePylonTileEntity>();
		...
		public override NPCShop.Entry GetNPCShopEntry() {
			...
			shopEntry.AddCondition(Condition.InUnderworld);
		...
		public override void MouseOver(int i, int j) {
			...
			Main.LocalPlayer.cursorItemIconID = ModContent.ItemType<Items.Placeable.HellPylonItem>();
		}
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) {
			...
			ModContent.GetInstance<TileEntities.SimplePylonTileEntity>().Kill(i, j);
		}
		...
		*/
		...
		public override bool ValidTeleportCheck_BiomeRequirements(TeleportPylonInfo pylonInfo, SceneMetrics sceneData) {
            ...
            int pylonY = (int)pylonInfo.PositionInTiles.Y;

            // The Underworld starts at about (maxTilesY - 200) tiles from the top
            int underworldStart = Main.maxTilesY - 200;

			return (pylonY >= underworldStart); // && (Condition.InUnderworld.IsMet());
        }
		...
		*/
        ...
        public override void SpecialDraw(int i, int j, SpriteBatch spriteBatch) {
			...
			DefaultDrawPylonCrystal(spriteBatch, i, j, crystalTexture, crystalHighlightTexture, new Vector2(0f, -12f), Color.White * 0.1f, Color.Orange, 4, CrystalVerticalFrameCount);
		}
		...
		public override void DrawMapIcon(ref MapOverlayDrawContext context, ref string mouseOverText, TeleportPylonInfo pylonInfo, bool isNearPylon, Color drawColor, float deselectedScale, float selectedScale) {
			...
			DefaultMapClickHandle(mouseOver, pylonInfo, ModContent.GetInstance<Items.Placeable.HellPylonItem>().DisplayName.Key, ref mouseOverText);
		}
	}
}
