...
namespace AIO.Content.Tiles {
    public class AIOre : ModTile {
        public override void SetStaticDefaults() {
            ...
            AddMapEntry(new Color(48, 255, 230), name);

            DustType = DustID.Chlorophyte;
            VanillaFallbackOnModDeletion = TileID.Adamantite;
    ...
    public class AIOreSystem : ModSystem {
        public static LocalizedText AIOrePassMessage { get; private set; }

        public override void SetStaticDefaults() {
            AIOrePassMessage = Mod.GetLocalization($"WorldGen.{nameof(AIOrePassMessage)}");
        }
        ...
        public override void ModifyWorldGenTasks(List<GenPass> tasks, ref double totalWeight) {
            ...
            if (ShiniesIndex != -1) {
                ...
                tasks.Insert(ShiniesIndex + 1, new AIOrePass("AIOres", 237.4298f));
            }
        }
    }

    public class AIOrePass : GenPass {
        public AIOrePass(string name, float loadWeight) : base(name, loadWeight) {
        }
        ...
        protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration) {
            ...
            progress.Message = AIOreSystem.AIOrePassMessage.Value;

            // Ores are quite simple, we simply use a for loop and the WorldGen.TileRunner to place splotches of the specified Tile in the world.
            // "6E-05" is "scientific notation". It simply means 0.00006 but in some ways is easier to read.
            int k = 0;
            while (k < (int)(Main.maxTilesX * Main.maxTilesY * 0.00001)) {
                ...
                // WorldGen.TileRunner(x, y, WorldGen.genRand.Next(1, 3), WorldGen.genRand.Next(5, 20), ModContent.TileType<AIOre>());
                ...
                if (tile.HasTile && (tile.TileType == TileID.SnowBlock || tile.TileType == TileID.IceBlock)) {
                    WorldGen.TileRunner(x, y, WorldGen.genRand.Next(1, 3), WorldGen.genRand.Next(5, 20), ModContent.TileType<AIOre>(), false, 0, 0, false, true);
                    k++;
                } else {
