...
namespace AIO.Content.Items.Placeable
{
	...
	/// </summary>
	public class HellPylonItem : ModItem
	{
		public override void SetDefaults() {
			...
			Item.DefaultToPlaceableTile(ModContent.TileType<Tiles.HellPylonTile>());

			// Another shorthand method that will set the rarity and how much the item is worth.
			Item.SetShopValues(ItemRarityColor.Blue1, Terraria.Item.buyPrice(gold: 50));
		}
	}
}
